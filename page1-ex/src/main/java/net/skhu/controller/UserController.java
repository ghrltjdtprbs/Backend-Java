...
public class UserController {
    ...
    public String list(Model model, Pagination pagination) {
        model.addAttribute("users", userMapper.findAll(pagination));
        pagination.setRecordCount(userMapper.getCount());
        return "user/list";
    }
    ...
    public String create(Model model, Pagination pagination,
        ...
        int lastPage = (int)Math.ceil((double)userMapper.getCount() / pagination.getSz());
